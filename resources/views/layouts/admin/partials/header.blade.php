                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="header-language">
                        <div class="flex-shrink-0 dropdown" id="lang_selector">
                            <a aria-expanded="false" class="d-block head-icon ps-0" data-bs-toggle="dropdown"
                                href="#">
                    ...
                    <li class="header-apps">
                        <a aria-controls="appscanvasRights"
                            ...
                            data-bs-target="#appscanvasRights" data-bs-toggle="offcanvas" href="#" role="button">
                            ...
                            <div class="offcanvas-body app-scroll">
                                <div class="row row-cols-3 g-2">
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-primary w-100 rounded-3 py-3 px-2 " href="product.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-danger w-100 rounded-3 py-3 px-2 " href="email.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-success w-100 rounded-3 py-3 px-2 " href="chat.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-warning w-100 rounded-3 py-3 px-2 "
                                            href="project_app.html" target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-info w-100 rounded-3 py-3 px-2 " href="invoice.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-dark w-100 rounded-3 py-3 px-2 " href="blog.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-danger w-100 rounded-3 py-3 px-2 " href="calendar.html"
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-warning w-100 rounded-3 py-3 px-2 "
                                            href="file_manager.html" target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-primary w-100 rounded-3 py-3 px-2 " href="gallery.html "
                                            target="_blank">
                                            <span>
                                    ...
                                    <div class="d-flex-center text-center">
                                        <a class="text-light-success w-100 rounded-3 py-3 px-2 " href="profile.html"
                                            target="_blank">
                                            <span>
                    ...
                    <li class="header-cart">
                        ...
                        <div aria-labelledby="cartcanvasRightLabel" class="offcanvas offcanvas-end header-cart-canvas"
                            id="cartcanvasRight" tabindex="-1">
                            <div class="offcanvas-header">
                                ...
                                <div class="head-container">
                                    <div class="notification-message head-box">
                                        ...
                                        <div class="message-content-box flex-grow-1 pe-2">
                                            ...
                                            <a class="f-s-15 text-dark mb-0" href="./read_email.html"><span
                    ...
                    <li class="header-profile-settings">
                        ...
                        <div class="d-flex align-items-center nav-profile px-3">
                            ...
                            <div class="dropdown profile-menu-dropdown">
                                ...
                                <span aria-expanded="false" data-bs-auto-close="true" data-bs-placement="top"
                                    data-bs-toggle="dropdown" role="button"
                                    class="h-45 w-45 d-flex-center b-r-10 position-relative bg-danger m-auto">

                                    <img class="img-fluid b-r-10"
                                        src="https://ui-avatars.com/api/?name=Mohtamjir&amp;background=28a745&amp;color=fff&amp;bold=true">
                                    <span
